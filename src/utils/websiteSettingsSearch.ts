...
const queryAliasMap: Record<string, string[]> = {
  ...
  login: ['sign in', 'signin', 'phone', 'sms', 'otp', 'authentication'],
  signin: ['sign in', 'login', 'phone', 'sms', 'otp'],
  sms: ['phone', 'mobile', 'otp', 'login'],
  otp: ['phone', 'sms', 'mobile', 'login'],
  default: ['theme', 'color', 'visitor', 'preset', 'first visit', 'shipped'],
  visitor: ['default', 'theme', 'color', 'client'],
  theme: ['color', 'background', 'motion', 'surface', 'contrast', 'default', 'visitor', 'preset'],
  color: ['theme', 'palette', 'background', 'accent', 'default'],
